package com.antonialucianapires.checkoutproducer.sqs;

import com.antonialucianapires.checkoutproducer.utils.Json;
...
public class SqsPublisher {
    ...
    public <T> Mono<SendMessageResponse> sendToProcessOrderQueue(final T object,
                                                                 ...
                                                                 final String queue) {
        final String messageBody = Json.toJson(object);
